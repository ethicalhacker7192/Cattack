...
# Note that I skipped reconnasaince, in a real-life scenario, your number 1 priority should be to gain as much information as you can about your target before running any exploits, this option is infinitely more stealthy and practical if done properly.
